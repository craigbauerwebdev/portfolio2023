...
const Social = (baseUrl) => {
  return (
    <>
      ...
      <a href="https://www.linkedin.com/in/craigbauerwebdev" target="_blank">
        <svg
          opacity=".8"
          height="34"
          xmlns="http://www.w3.org/2000/svg"
      ...
      {/* https://codepen.io/craigbauerwebdev */}
      {/*<a href="https://www.codewars.com/users/craigbauerwebdev" target="_blank">
        <svg
          opacity="8"
          height="34"
          xmlns="http://www.w3.org/2000/svg"
